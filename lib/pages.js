...
function presenterPage(r, port, version) {
  return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<body>
<main id="deck" data-deck="${esc(r.deck.key)}" data-version="${esc(String(version || ''))}">
${r.html}
</main>
...
module.exports = { deckPage, presenterPage, printPage, errorPage };
